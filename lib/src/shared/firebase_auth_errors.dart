const errors = {
  ...
  'expired-action-code': 'O código da ação ou o link expirou.',
  'invalid-action-code':
      'O código da ação é inválido. Isso pode acontecer\nse o código estiver malformado ou já tiver sido\nusado.',
  'user-disabled':
      'O usuário correspondente à credencial fornecida\nfoi desativado.',
  'user-not-found': 'Não existe conta com o e-mail fornecido.',
  'weak-password': 'A senha é muito fraca.',
  'email-already-in-use':
      'Já existe uma conta com o endereço de e-mail\nfornecido.',
  'invalid-email': 'O endereço de e-mail não é válido.',
  'operation-not-allowed':
      'O tipo de conta correspondente à esta credencial,\nainda não encontra-se ativada.',
  'account-exists-with-different-credential':
      'E-mail já associado a outra conta.',
  'auth-domain-config-required':
      'A configuração para autenticação não foi\nfornecida.',
  'credential-already-in-use': 'Já existe uma conta para esta credencial.',
  'operation-not-supported-in-this-environment':
      'Esta operação não é suportada no ambiente que\nestá sendo executada. Verifique se deve ser http\nou https.',
  'timeout':
      'Excedido o tempo de resposta. O domínio pode\nnão estar autorizado para realizar operações.',
  'missing-android-pkg-name':
      'Deve ser fornecido um nome de pacote para\ninstalação do aplicativo Android.',
  ...
  'unauthorized-continue-uri':
      'O domínio da próxima URL não está na lista de\nautorizações.',
  'invalid-dynamic-link-domain':
      'O domínio de link dinâmico fornecido, não está\nautorizado ou configurado no projeto atual.',
  'argument-error': 'Verifique a configuração de link para o aplicativo.',
  'invalid-persistence-type':
      'O tipo especificado para a persistência dos\ndados é inválido.',
  'unsupported-persistence-type':
      'O ambiente atual não suportar o tipo\nespecificado para persistência dos dados.',
  ...
  'captcha-check-failed':
      'O token de resposta do reCAPTCHA não é válido,\nexpirou ou o domínio não é permitido.',
  'invalid-phone-number':
      'O número de telefone está em um formato inválido\n(padrão E.164).',
  'missing-phone-number': 'O número de telefone é requerido.',
  'quota-exceeded': 'A cota de SMS foi excedida.',
  'cancelled-popup-request':
      'Somente uma solicitação de janela pop-up é\npermitida de uma só vez.',
  'popup-blocked': 'A janela pop-up foi bloqueado pelo navegador.',
  'popup-closed-by-user':
      'A janela pop-up foi fechada pelo usuário sem\nconcluir o login no provedor.',
  'unauthorized-domain':
      'O domínio do aplicativo não está autorizado para\nrealizar operações.',
  ...
  'app-not-authorized':
      'Aplicação não autorizada para autenticar com a\nchave informada.',
  'invalid-api-key': 'A chave da API fornecida é inválida.',
  'network-request-failed': 'Falha de conexão com a rede.',
  'requires-recent-login':
      'O último horário de acesso do usuário não atende\nao limite de segurança.',
  'too-many-requests':
      'As solicitações foram bloqueadas devido a atividades\nincomuns. Tente novamente depois que algum tempo.',
  'web-storage-unsupported':
      'O navegador não suporta armazenamento ou se o\nusuário desativou este recurso.',
  'invalid-claims': 'Os atributos de cadastro personalizado são inválidos.',
  'claims-too-large':
      'O tamanho da requisição excede o tamanho máximo\npermitido de 1 Megabyte.',
  ...
  'invalid-hash-salt-separator':
      'O campo do separador de SALT do algoritmo de\ngeração de HASH precisa ser um buffer de byte\nválido.',
  'invalid-id-token': 'O código do token informado não é válido.',
  'invalid-last-sign-in-time':
      'O último horário de login precisa ser uma data\nUTC válida.',
  ...
  'invalid-session-cookie-duration':
      'A duração do COOKIE da sessão precisa ser um número\nválido em milissegundos, entre 5 minutos e 2 semanas.',
  'invalid-uid':
      'O identificador fornecido deve ter no máximo\n128 caracteres.',
  ...
  'maximum-user-count-exceeded':
      'O número máximo permitido de usuários a serem\nimportados foi excedido.',
  'missing-hash-algorithm':
      'É necessário fornecer o algoritmo de geração de\nHASH e seus parâmetros para importar usuários.',
  'missing-uid': 'Um identificador é necessário para a operação atual.',
  'reserved-claims':
      'Uma ou mais propriedades personalizadas\nfornecidas usaram palavras reservadas.',
  ...
  'insufficient-permission':
      'A credencial utilizada não tem permissão para\nacessar o recurso solicitado.',
  'internal-error':
      'O servidor de autenticação encontrou um erro\ninesperado ao tentar processar a solicitação.'
};
